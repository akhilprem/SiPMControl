...
class SCDMainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, parent = None):
        ...
        self._channelVoltageCurrentModel = QtGui.QStandardItemModel(self.NUM_ROWS, 3, self)
    ...
    def setPresenter(self, presenter):
        ...
        self._channelVoltageCurrentModel.itemChanged.connect(self._presenter.handleBVChange)
